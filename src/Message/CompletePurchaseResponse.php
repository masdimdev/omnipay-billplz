...
class CompletePurchaseResponse extends AbstractResponse
{
    ...
    {
        return isset($this->data['billplz']['paid']) && filter_var($this->data['billplz']['paid'], FILTER_VALIDATE_BOOLEAN);
    }
    ...
    {
        return $this->data['billplz']['paid_at'] ?? null;
    }
    ...
    public function isSignatureValid(): bool
    {
        ...
        $signature = $data['billplz']['x_signature'] ?? null;
    ...
    {
        return $this->data['billplz']['id'] ?? null;
    }
